 ...
 *
 * API tests for ExportacionesApi 
 */
public class ExportacionesApiTest {


    private ExportacionesApi api;
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://virtserver.swaggerhub.com/oreon3000organizatio/api-exportacion-loterias-std/1.2", ExportacionesApi.class, providers);
     ...
     */
    @Test
    public void exportacionesGetTest() {
        String entidad = null;
        LocalDate fechaDesde = null;
        String moneda = null;
        LocalDate fechaHasta = null;
        String tipoLoteria = null;
        String juego = null;
        //ExportResponse response = api.exportacionesGet(entidad, fechaDesde, moneda, fechaHasta, tipoLoteria, juego);
