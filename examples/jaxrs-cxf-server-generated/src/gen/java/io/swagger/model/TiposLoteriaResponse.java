...
public class TiposLoteriaResponse   {
  ...
  @Schema(description = "Lista de tipos de lotería disponibles")
 /**
   * Lista de tipos de lotería disponibles  
  **/
  ...
  **/
  ...
  public TiposLoteriaResponse tipoLoteria(List<TipoLoteriaEnum> tipoLoteria) {
    this.tipoLoteria = tipoLoteria;
    return this;
  }

  public TiposLoteriaResponse addTipoLoteriaItem(TipoLoteriaEnum tipoLoteriaItem) {
  ...
  public String toString() {
    ...
    sb.append("class TiposLoteriaResponse {\n");
